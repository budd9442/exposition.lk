...
const members: Member[] = [
  {
    ...
    image: '/expo/assets/team/lavindu.png',
  ...
  },
  {
    ...
    image: '/expo/assets/team/hashani.png',
  ...
  },
  {
    ...
    image: '/expo/assets/team/akila.png',
  ...
  },
  {
    ...
    phone: '071 684 6120',
    image: '/expo/assets/team/nevindi.png',
          ...
          {members.map((member, idx) => (
            ...
            >
              <div className="text-center mb-6">
                <div className="w-48 h-48 mx-auto mb-4 rounded-full overflow-hidden border-4 border-[#e3c767]/20 hover:border-[#e3c767]/50 transition-all">
